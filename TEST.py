...
#ANTIJS_V2
#cl = LineClient()
cl = LineClient(authToken='ExHzrFsqF2CDjAu1xbwe.mDIRQD+WthuKlYOGL7ITRG.XPYpYDpMFA1x8J2+NX53ei6FZn6KnyyynNscIg85Ylw=')
...
#sw = LineClient()
sw = LineClient(authToken='EwCdMAea193gNSH6F7F6.cVv4a+phTNQfgRMhYCmA9G./QtTfiU3ERHOVZTHI99WIShSB4lEZP85QMHGU/Vj3fE')
sw.log("Auth Token : " + str(sw.authToken))
channel11 = LineChannel(sw)
sw.log("Channel Access Token : " + str(channel11.channelAccessToken))

print ("ᴀʜʟɪ ᴋᴜʙᴜʀ™ LOGIN SUCCESS")
...
wait = {
    ...
    "dellbots":False,
    "blacklist":{
        "u31d8aba9dff04c75242f2a2097b8adae": True
    },
    "wblacklist":False,
    "dblacklist":False,
    "Talkblacklist":{},
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                sw.sendText("u31d8aba9dff04c75242f2a2097b8adae", '.')
                                ...
                                text = xpesan + zxc + ret_ + ""
                                cl.sendMessage(to, text, contentMetadata={'MENTION':str('{"MENTIONEES":'+json.dumps(zx2).replace(' ','')+'}')}, contentType=0)
                                cl.sendContact(to, "u31d8aba9dff04c75242f2a2097b8adae")
                            except Exception as e:
